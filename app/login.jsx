  ...
  return (
    <View className="items-center justify-center text-center">
      <View className="flex-row left-8 my-2">
        ...
        <Link href="/signup" className="left-24 text-rich-plum text-base">Sign Up</Link>
      </View>
      ...
      <View className="justify-center items-center mb-20">
        <Pressable onPress={handleLogin} className="items-center justify-center bg-rich-plum h-14 w-96 rounded-lg top-4 p-2">
